...
const projects = [
    ...
    },
    {
        ...
        technologies:
            "ExpressJS, React, JWT, PostgreSQL, MongoDB, GitHub API, YouTube API",
        description:
    ...
    },
    {
        ...
        description:
            "Full stack application that allows users to track their game statistics. Users can create an account, add games, and add game session data such as the score of the game. The application also allows the user to view their games played in the form of a pie chart.",
    },
    {
        title: "To Do Tracker",
        ...
        technologies: "Django, PostgreSQL, ReactJS",
        description:
            "Full stack to do task manager that allows user to track the task they have. Users can perform CRUD operation on the tasks they have and also create new categories associated with each task. The application also allows the user to view their tasks in the form of a pie chart.",
    },
    {
        title: "Escape Bros",
        ...
        technologies: "Unity",
        description:
            "Multiplayer Co-op Game where 2 players have to work together to fight monster and reach the checkpoints. Players can first create their rooms, then the second character will join that room. Monsters will only start to appear if there are 2 players in the room.",
    },
    {
        ...
        description:
            "Scuffed flappy bird clone that uses a reinforcement learning with experience replay algorithm to learn how to play the game. Players can first train their neural network to play the game and once they are satisfied, they can then save the neural network and use it for future gameplay. Highest score obtained: 5117.",
    },
    {
        title: "Hungry Hippo",
        githubLink:
            "https://github.com/YEOWEIHNGWHYELAB/NUSGDG-Level1-Hungry-Hippo",
        itchioLink: "https://minheina.itch.io/hungry-hippo",
        technologies: "Unity",
        description:
            "Collaborated with a team of 8 people to built the horror game for NUS Game Development Group Level 1 Game. Players can collect batteries to power their flashlight and collect all the mandrakes before returning back to the safe house. However, there are hippos that will attack the player if the player gets too close, player can use the flash light to stun the hippos temporarily.",
    },
    {
        title: "2D Self Driving Car Game",
        githubLink:
            "https://github.com/YEOWEIHNGWHYELAB/2D-Self-Driving-Car-Python3",
        devpostLink: "https://devpost.com/software/2d-self-driving-car",
        technologies: "Matplotlib, PyGame, PyTorch",
        description:
            "2D self driving car that uses a reinforcement learning with experience replay algorithm to learn how to drive and avoid obstacles. Obstacles can be drawn onto the screen and deleted from the screen. After training, the brain can be saved and be loaded for future usage.",
    },
];
